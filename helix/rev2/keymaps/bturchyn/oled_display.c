...
static void render_layer_base_name(void) {
  switch(default_layer_state) {
    ...
    case L_DVORAK:
      ...
      break;
    case L_MACRO_WIN:
      oled_write_P(PSTR("Macro Win"), false);
      break;
    case L_MACRO_OSX:
      oled_write_P(PSTR("Macro OSX"), false);
      break;
    default:
...
static void render_layer_base_name(struct CharacterMatrix *matrix) {
  switch(default_layer_state) {
    case L_QWERTY:
      oled_write_P(PSTR("Qwerty"), false);
      break;
